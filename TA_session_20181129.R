...
# Pr of specific values in the distribution i.e., f(x) = Pr(X=x)
dbinom(900, size = 1000, prob = c(0.9))

# Cummulative Probability of values i.e., F(x) Pr(X<=q)
...
rmarkdown::render("TA_session_20181129.R","pdf_document")
